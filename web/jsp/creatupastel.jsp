        ...
        <form class="formulario" action="Pedido" method="post">
            ...
            <select name="porciones">
                ...
                for(int i = 0; i < listaPorciones.size(); i++) {
                    ...
                    <option value="<%= porcion.id %>"><%= porcion.cantidad %></option>
                <%
                }%>
            </select>
            <p class="animated bounceIn">Tipo de molde</p>
             <select name="molde">
                ...
                for(int i = 0; i < listaMoldes.size(); i++) {
                    ...
                    <option value="<%= molde.id %>"><%= molde.tipo %></option>
                <%
                }%>
            </select>
            ...
            <select name="tpTorta" id="tpTorta">
                ...
                <option value="1">Secas</option>
                <option value="2">Postre</option>
                <option value="3">Refrigerada</option>
            </select>
            <button type="submit" class="animated zoomInRight">Crear</button>
        </form>
    </div>
</body>
